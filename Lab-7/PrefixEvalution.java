...
public class PrefixEvalution{
	...
	public static String mainPrefixEval(String equation){
		
		String[] tempArray = equation.split(",");
		...
		for(String temp : tempArray){
			...
			if(!isOperater(temp)){
				...
				stack.push(evalExp(num1, num2, temp));
			}
	...
	public static void main(String[] args){
		...
		System.out.println("Your Answer Is: " + mainPrefixEval(evalUserIn));
	}
